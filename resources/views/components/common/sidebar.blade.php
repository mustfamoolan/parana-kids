        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a href="{{ auth()->check() && (auth()->user()->isAdmin() || auth()->user()->isSupplier()) ? route('admin.dashboard') : route('delegate.dashboard') }}" class="nav-link group">
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group w-full" @click="toggleMenu('orders')">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">إدارة الطلبات</span>
                        </div>
                        <div>
...
<li class="menu nav-item">
    <a href="{{ route('delegate.carts.index') }}" class="nav-link group">
        <div class="flex items-center">
            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m6-5v6a2 2 0 01-2 2H9a2 2 0 01-2-2v-6m8 0V9a2 2 0 00-2-2H9a2 2 0 00-2 2v4.01" stroke="currentColor" stroke-width="2"/>
            </svg>
            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">السلال</span>
            @php
                $activeCartsCount = auth()->check() ? auth()->user()->carts()->where('status', 'active')->count() : 0;
            @endphp
            @if($activeCartsCount > 0)
                <span class="badge badge-primary ltr:ml-auto rtl:mr-auto">{{ $activeCartsCount }}</span>
            @endif
        </div>
    </a>
</li>
                ...
                <li class="menu nav-item">
                    <a href="#" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">المهام</span>
                        </div>
                    </a>
                </li>
                @endif
