                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div x-show="selectedRole === 'supplier'" class="mt-4 flex items-center">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="is_observer" value="1" class="form-checkbox text-primary" {{ old('is_observer', $user->is_observer) ? 'checked' : '' }}>
                    ...
                    <div x-show="selectedRole === 'delegate'" class="col-span-1 md:col-span-2 mt-4">
                        ...
                        <select id="suggested_suppliers" name="suggested_suppliers[]" class="form-select" multiple style="min-height: 120px;">
                            @foreach($suppliers as $supplier)
                                <option value="{{ $supplier->id }}" {{ (is_array(old('suggested_suppliers', $user->suggestedSuppliers->pluck('id')->toArray())) && in_array($supplier->id, old('suggested_suppliers', $user->suggestedSuppliers->pluck('id')->toArray()))) ? 'selected' : '' }}>
