<x-layout.admin>
    <div class="panel">
                <div class="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">إنشاء طلب جديد</h5>
                    <a href="{{ route('admin.alwaseet.orders') }}" class="btn btn-outline-primary">
                ...
                <form method="POST" action="{{ route('admin.alwaseet.orders.store') }}">
                    @csrf
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div class="panel">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="client_mobile" id="client_mobile" value="{{ old('client_mobile') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="client_mobile2" id="client_mobile2" value="{{ old('client_mobile2') }}"
                        ...
                        <div class="panel">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="region_id" id="region_id" class="form-select" required disabled>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="location" id="location" rows="3" class="form-textarea" required>{{ old('location') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="package_size" id="package_size" class="form-select" required>
                                    ...
                                    @foreach($packageSizes as $size)
                                        <option value="{{ $size['id'] }}" {{ old('package_size') == $size['id'] ? 'selected' : '' }}>
                                            {{ $size['size'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="type_name" id="type_name" value="{{ old('type_name', 'ملابس') }}"
                                       class="form-input" required>
                            </div>

                            <div class="mb-4">
                                <label for="items_number" class="mb-2 block text-sm font-medium">عدد القطع <span class="text-danger">*</span></label>
                                <input type="number" name="items_number" id="items_number" value="{{ old('items_number', '1') }}"
                        ...
                        <div class="panel">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="merchant_notes" id="merchant_notes" rows="3" class="form-textarea">{{ old('merchant_notes') }}</textarea>
                            </div>

                            <div class="mb-4">
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" name="replacement" value="1" {{ old('replacement') ? 'checked' : '' }} class="form-checkbox">
                    ...
                    <div class="mt-5 flex gap-2">
                        ...
                        <a href="{{ route('admin.alwaseet.orders') }}" class="btn btn-outline-secondary">إلغاء</a>
                    </div>
                </form>
            </div>
        </div>
