<x-layout.admin>
    <div class="panel">
        <div class="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <h5 class="text-lg font-semibold dark:text-white-light">إضافة مخزن خاص جديد</h5>
        ...
        <form method="POST" action="{{ route('admin.private-warehouses.store') }}" class="space-y-5">
            @csrf
