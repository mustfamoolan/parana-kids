                ...
                @foreach($warehouses as $warehouse)
                    <div class="panel">
                        ...
                        <div class="flex flex-wrap gap-2 mt-4 pt-4 border-t">
                            @can('view', $warehouse)
                                <a href="{{ route('admin.warehouses.show', $warehouse) }}?back_url={{ urlencode(request()->fullUrl()) }}" class="btn btn-sm btn-outline-primary flex-1" title="عرض التفاصيل">
                            ...
                            @can('update', $warehouse)
                                <a href="{{ route('admin.warehouses.edit', $warehouse) }}?back_url={{ urlencode(request()->fullUrl()) }}" class="btn btn-sm btn-outline-warning flex-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
