        ...
        <form method="POST" action="{{ route('admin.warehouses.products.update', [$product->warehouse, $product]) }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="panel">
                ...
                <div class="mt-5">
                    ...
                    @enderror
                    <!-- Preview -->
                    <div id="youtube-preview" class="mt-3 {{ old('youtube_url', $product->youtube_url) ? '' : 'hidden' }}">
                        <div class="relative rounded-xl overflow-hidden bg-black" style="aspect-ratio:16/9; max-width:480px;">
                            <iframe id="youtube-iframe"
                                src="{{ $product->getYoutubeEmbedId() ? 'https://www.youtube.com/embed/' . $product->getYoutubeEmbedId() : '' }}"
                                class="w-full h-full"
                                frameborder="0"
