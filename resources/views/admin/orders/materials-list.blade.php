                        ...
                        <div class="mb-4 pb-3 border-b">
                            ...
                            <div class="flex flex-col gap-2">
                                @can('update', $order)
                                    @php
                                        $editOrderParams = [
                                            'back_route' => 'admin.orders.materials.management',
                                            'back_params' => urlencode(json_encode(array_filter([
                                                'warehouse_id' => request('warehouse_id'),
                                                'search' => request('search'),
                                                'confirmed_by' => request('confirmed_by'),
                                                'delegate_id' => request('delegate_id'),
                                    ...
                                    @endphp
                                    <a href="{{ route('admin.orders.edit', array_merge([$order], $editOrderParams)) }}" class="btn btn-primary w-full">
