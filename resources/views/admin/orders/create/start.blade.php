<x-layout.admin>
    <div class="panel p-0">
        ...
        <div class="p-5">
            <form action="{{ route('admin.orders.create.initialize') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    <label for="customer_phone2" class="font-semibold">رقم الهاتف الثاني (اختياري)</label>
                    <input
                        type="tel"
                        id="customer_phone2"
                        name="customer_phone2"
                        value="{{ old('customer_phone2') }}"
                        placeholder="07742209251"
                        class="form-input"
