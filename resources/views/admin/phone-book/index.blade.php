                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-2">
                                @foreach($contact->phoneNumbers as $phoneNumber)
                                    <div class="flex flex-col sm:flex-row sm:items-center gap-2 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                        <div class="flex-1">
                                            <span class="text-base font-medium">{{ $phoneNumber->phone_number }}</span>
                                        </div>
                                        <div class="flex gap-2">
                                            ...
                                            <!-- زر حذف الرقم -->
                                            <form method="POST" action="{{ route('admin.phone-book.delete-phone', $phoneNumber->id) }}" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا الرقم؟');">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="mt-3">
                                <form method="POST" action="{{ route('admin.phone-book.add-phone', $contact->id) }}" class="flex gap-2">
                                    @csrf
