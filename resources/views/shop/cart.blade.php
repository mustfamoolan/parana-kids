<x-layout.default>
    <div class="container mx-auto px-4 py-6 max-w-6xl">
        ...
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold">السلة</h1>
        ...
        <div class="panel">
            ...
            @if($cart->items->count() > 0)
                ...
                <!-- Total Amount -->
                <div class="panel bg-primary-light dark:bg-primary/20 border-2 border-primary mb-5">
                    <div class="flex items-center justify-between">
                        <span class="text-lg font-bold text-gray-700 dark:text-gray-300">المجموع الكلي:</span>
                        <span class="text-3xl font-bold text-primary">{{ number_format($cart->total_amount, 0) }} د.ع</span>
                    </div>
                </div>
                ...
                <div class="flex gap-3 justify-end mt-5 pt-5 border-t">
                    ...
                    <!-- زر إتمام الطلب سيتم إضافته لاحقاً -->
                </div>
            @else
