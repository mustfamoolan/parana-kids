            ...
            <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">تسجيل دخول المندوب</h1>
                            <p class="text-base font-bold leading-normal text-white-dark">أدخل الكود وكلمة المرور</p>
                        </div>
                        <form class="space-y-5 dark:text-white" method="POST" action="{{ route('delegate.login') }}">
                            @csrf
                            <div>
                                <label for="code">الكود</label>
                                <div class="relative text-white-dark">
                                    <input id="code" name="code" type="text" placeholder="أدخل الكود" class="form-input ps-10 placeholder:text-white-dark" value="{{ old('code') }}" />
                        ...
                        <div class="text-center dark:text-white">
                            هل أنت مدير أو مجهز؟
                            <a href="{{ route('admin.login') }}" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">تسجيل دخول المدير</a>
                        </div>
                    </div>
