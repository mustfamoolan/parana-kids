            ...
            <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">تسجيل دخول المدير والمجهز</h1>
                            <p class="text-base font-bold leading-normal text-white-dark">أدخل رقم الهاتف أو الكود وكلمة المرور</p>
                        </div>
                        <form class="space-y-5 dark:text-white" method="POST" action="{{ route('admin.login') }}">
                            @csrf
                            <div>
                                <label for="login_field">رقم الهاتف أو الكود</label>
                                <div class="relative text-white-dark">
                                    <input id="login_field" name="login_field" type="text" placeholder="أدخل رقم الهاتف أو الكود" class="form-input ps-10 placeholder:text-white-dark" value="{{ old('login_field') }}" />
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="password" name="password" type="password" placeholder="أدخل كلمة المرور" class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                        ...
                        <div class="text-center dark:text-white">
                            هل أنت مندوب؟
                            <a href="{{ route('delegate.login') }}" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">تسجيل دخول المندوب</a>
                        </div>
                    </div>
