<x-layout.default>
    <div class="panel">
        ...
        <form method="POST" action="{{ route('delegate.product-links.store') }}" class="space-y-5" id="product-link-form">
            @csrf
            ...
            <div class="flex justify-end gap-3 mt-8">
                <a href="{{ route('delegate.product-links.index') }}" class="btn btn-outline-secondary">إلغاء</a>
