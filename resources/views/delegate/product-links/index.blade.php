    ...
    <div class="panel">
        <div class="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                <a href="{{ route('delegate.product-links.create') }}" class="btn btn-primary">
                    ...
                    <div class="panel">
                        <div class="space-y-3">
                            ...
                            <div class="flex gap-2 pt-2 border-t">
                                ...
                                <form
                                    action="{{ route('delegate.product-links.destroy', $link->id) }}"
                                    method="POST"
                                    class="flex-1"
        ...
        @else
            <div class="text-center py-10">
                ...
                <a href="{{ route('delegate.product-links.create') }}" class="btn btn-primary mt-4">
                    إنشاء رابط جديد
                </a>
            </div>
        @endif
