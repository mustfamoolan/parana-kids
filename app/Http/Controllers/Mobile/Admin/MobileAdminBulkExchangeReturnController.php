...
class MobileAdminBulkExchangeReturnController extends Controller
{
    /**
    ...
    public function getFilterOptions()
    {
        ...
        try {
            ...
            Log::error('MobileAdminBulkExchangeReturnController: Failed to get filter options', [
                'error' => $e->getMessage(),
    ...
    public function searchProducts(Request $request)
    {
        ...
        try {
            ...
            Log::error('MobileAdminBulkExchangeReturnController: Failed to search products', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString(),
                'user_id' => $user->id,
                'request' => $request->all(),
    ...
    /**
     * إرجاع/استبدال المنتجات بشكل جماعي
     *
     * @param Request $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function returnProducts(Request $request)
    {
        ...
        try {
            ...
            Log::error('MobileAdminBulkExchangeReturnController: Failed to return products', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString(),
                'user_id' => $user->id,
                'request' => $request->all(),
