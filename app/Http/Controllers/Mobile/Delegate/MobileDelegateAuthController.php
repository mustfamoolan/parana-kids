...
class MobileDelegateAuthController extends Controller
{
    /**
     * تسجيل دخول للمندوب
     *
    ...
    /**
     * معلومات المستخدم الحالي (للمندوب فقط)
     *
     * @param Request $request
     * @return \Illuminate\Http\JsonResponse
     */
    ...
    public function logout(Request $request)
    {
        ...
        try {
            ...
            Log::error('MobileDelegateAuthController: Error in logout', [
                'user_id' => $user->id,
                'error' => $e->getMessage(),
            ]);
    ...
    /**
     * تحديث الملف الشخصي (صورة البروفايل فقط للمندوب)
     *
     * @param Request $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            Log::error('MobileDelegateAuthController: Failed to upload profile image', [
                'user_id' => $user->id,
                'error' => $e->getMessage(),
            ]);
