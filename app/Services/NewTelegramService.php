...
class NewTelegramService
{
    ...
    public function sendMessage($chatId, $message, $parseMode = 'HTML', $replyMarkup = null)
    {
        ...
        try {
            ...
            Log::info('NewTelegramService: Message sent successfully', [
                'chat_id' => $chatId,
            ...
            Log::error('NewTelegramService: Failed to send message', [
                'chat_id' => $chatId,
                'error' => $e->getMessage(),
            ]);
    ...
    {
        $chatIds = $user->getNewTelegramChatIds();
        ...
        foreach ($chatIds as $chatId) {
            try {
                ...
                Log::error('NewTelegramService: Failed to send to device', [
                    'user_id' => $user->id,
                    'chat_id' => $chatId,
                    'error' => $e->getMessage(),
                ]);
    ...
    public function sendOrderNotification($chatId, $order)
    {
        ...
        $message = "🔔 <b>طلب جديد (البوت الجديد)</b>\n\n";
    ...
    public function sendOrderUpdatedNotification($chatId, $order)
    {
        ...
        $message = "📝 <b>تعديل على الطلب (البوت الجديد)</b>\n\n";
        $message .= "📦 {$order->order_number}\n";
        $message .= "👤 {$order->customer_name}\n";
    ...
    public function getMe()
    {
        ...
        try {
            ...
            Log::error('NewTelegramService: Failed to get bot info', [
                'error' => $e->getMessage(),
            ]);
            return null;
        }
    ...
    public function sendOrderStatusNotification($chatId, $shipment, $order, $customStatus = null)
    {
        ...
        $message = "📊 <b>{$status} (البوت الجديد)</b>\n\n";
    ...
    public function sendOrderDeletedNotification($chatId, $order)
    {
        ...
        $message = "🗑️ <b>تم الحذف (البوت الجديد)</b>\n\n";
    ...
    public function sendOrderRestrictedNotification($chatId, $order)
    {
        ...
        $message = "🔒 <b>تم التقييد (البوت الجديد)</b>\n\n";
